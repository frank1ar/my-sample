namespace TouchWalkthrough
{
	...
	public class GestureRecognizerView : View
	{
        ...
        private int _activePointId_2 = InvalidPointerId;
		private float _lastTouchX;
		private float _lastTouchY;
		private float _posX;
		private float _posY;
		private float _scaleFactor = 1.0f;
        private readonly Drawable _bigImage;

		public GestureRecognizerView (Context context)
            : base(context, null, 0)
		{
            _bigImage = Resources.GetDrawable(Resource.Drawable.MonoMonkey);
            _bigImage.SetBounds(0, 0, _bigImage.IntrinsicWidth, _bigImage.IntrinsicHeight);
		...
		public override bool OnTouchEvent (MotionEvent ev)
		{
			...
			case MotionEventActions.Down:
                ...
                {
                   _activePointId_2 = ev.GetPointerId(1); //here we can handle the mutiple taps
                };
